...
let kyc_document_image = upload.fields([
  { name: "kyc_document_image", maxCount: 1 },
  { name: "kyc_document_image2", maxCount: 1 },
...
const {
  buyTokenSchema,
} = require("../middleware/validators/buyValidator.middleware");
const {
  withdrawSchema,
} = require("../middleware/validators/withdrawValidator.middleware");
const {
  adminLoginSchema,
  changePasswordSchema,
  blogvalidation,
  insertachieverSchema,
} = require("../middleware/validators/adminValidator.middleware");
const {
  ticketSchema,
} = require("../middleware/validators/exchange.middleware");
...
router.post(
  "/userRegister",
  registerUserSchema,
  registerController.userRegister.bind()
); //done
router.post(
  "/addNewsLetter",
  newsLetterSchema,
  registerController.addNewsLetter.bind()
);
router.post(
  "/contactFormRequest",
  contactRequestSchema,
  registerController.contactFormRequest.bind()
);
...
router.post(
  "/LoginWithAddress",
  LoginWithAddressSchema,
  loginController.LoginWithAddress.bind()
);
...
router.post(
  "/forgotPassword",
  ForgotPasswordSchema,
  loginController.ForgotPassword.bind()
); // done
router.post(
  "/resetpassword",
  ResetPasswordSchema,
...
router.post(
  "/getUserProfile",
  ensureWebToken,
  userController.getUserProfile.bind()
); // done
router.post(
  "/UpdateUserProfile",
  profileUplaod,
  ensureWebToken,
  userController.UpdateUserProfile.bind()
); //done
router.post(
  "/updatePassword",
  updatePasswordSchema,
...
router.post(
  "/deactiveaccount",
  ensureWebToken,
  userController.deactiveaccount.bind()
); //done
...
router.post(
  "/updatekycapproval",
  ensureWebTokenForAdmin,
  userController.updatekycapproval.bind()
);
router.post(
  "/rejectkycapproval",
  ensureWebTokenForAdmin,
  userController.rejectkycapproval.bind()
);
router.post(
  "/updatekyc",
  kyc_document_image,
  ensureWebToken,
  userController.updatekyc.bind()
);

router.post(
  "/updateiskyc",
  ensureWebTokenForAdmin,
  userController.updateiskyc.bind()
);
router.post(
  "/disableiskyc",
  ensureWebTokenForAdmin,
  userController.disableiskyc.bind()
);
...
router.post(
  ...
  ensureWebTokenForAdmin,
  userController.getMntWalletsDetails.bind()
);
router.post("/getPhase", ensureWebToken, userController.getPhase.bind());
router.post(
  "/getMntWalletDetails",
  ensureWebToken,
  userController.getMntWalletDetails.bind()
);
router.post(
  "/getTotalRefIncome",
  ensureWebToken,
  userController.getTotalRefIncome.bind()
);
router.post(
  "/getDirectReferralCount",
  ensureWebToken,
  userController.getDirectReferralCount.bind()
); // done
router.post(
  "/getReferralUsersList",
  ensureWebToken,
  userController.getReferralUsersList.bind()
);
router.post(
  "/getNodesList",
  ensureWebToken,
  userController.getNodesList.bind()
);
router.post(
  "/getstatisticsList",
  ensureWebToken,
  userController.getstatisticsList.bind()
);
router.post(
  "/getEarningProjections",
  ensureWebToken,
  userController.getEarningProjections.bind()
);
router.post(
  "/getTeamReferral",
  ensureWebToken,
  userController.getTeamReferral.bind()
); // done
router.post(
  "/getTeamReferralList",
  ensureWebToken,
  userController.getTeamReferralList.bind()
);
router.post(
  "/getRewardsList",
  ensureWebToken,
  userController.getRewardsList.bind()
);
router.post(
  "/getBlockExpansionIncome",
  ensureWebToken,
  userController.getBlockExpansionIncome.bind()
);
router.post(
  "/getTokenAllocation",
  ensureWebToken,
  userController.getTokenAllocation.bind()
);
router.post(
  "/getCapingPlan",
  ensureWebToken,
  userController.getCapingPlan.bind()
);
router.post(
  "/getUpcomingEventsList",
  userController.getUpcomingEventsList.bind()
);
router.post(
  "/exchangeicotransfer",
  ensureWebToken,
...
router.post(
  "/getActivePhase",
  ensureWebToken,
  buyController.getActivePhase.bind()
);
router.post(
  "/tokenPurchase",
  ensureWebToken,
  blogimages,
  buyController.tokenPurchase.bind()
);
router.post(
  "/stripetokenPurchase",
  ensureWebToken,
  buyController.stripePayment.bind()
);
router.post(
  "/getTokenPurchase",
  ensureWebToken,
  buyController.getTokenPurchase.bind()
);
...
router.post(
  "/userWithdraw",
  ensureWebToken,
  withdrawController.userWithdraw.bind()
);
router.post(
  "/getWithdrawList",
  ensureWebToken,
  withdrawController.getWithdrawList.bind()
); //done

/// By AJ strat ///
const {
  submitStackingSchema,
} = require("../middleware/validators/stackValidator.middleware");
const stackController = require("../controllers/stack.controller");
router.post(
  "/submitStacking",
  submitStackingSchema,
  ensureWebToken,
  stackController.submitStacking.bind()
);

router.post(
  "/getUserStackingHistory",
  ensureWebToken,
  stackController.getUserStackingHistory.bind()
); //done
router.post(
  "/getUserStackingHistorybyid",
  stackController.getUserStackingHistorybyid.bind()
); //done

router.post(
  "/getStackingPrice",
  ensureWebToken,
  stackController.getStackingPrice.bind()
);

router.post(
  "/getEarningHistory",
  ensureWebToken,
  stackController.getEarningHistory.bind()
); //done
...
router.post(
  ...
  ensureWebTokenForAdmin,
  adminController.getDashboardStatistics.bind()
);
router.post(
  "/getUsersList",
  ensureWebTokenForAdmin,
  adminController.getUsersList.bind()
);
...
router.post(
  "/getUsersReferrals",
  ensureWebTokenForAdmin,
  adminController.getUsersReferrals.bind()
);

router.post(
  "/getStackingHistory",
  ensureWebTokenForAdmin,
  adminController.getStackingHistory.bind()
);
router.post(
  "/getWithdrawalStatistics",
  ensureWebTokenForAdmin,
  adminController.getWithdrawalStatistics.bind()
);
router.post(
  "/getWithdrawalStatisticsCrypto",
  ensureWebTokenForAdmin,
  adminController.getWithdrawalStatisticsCrypto.bind()
);
router.post(
  "/getMntWithdrawalHistory",
  ensureWebTokenForAdmin,
  adminController.getMntWithdrawalHistory.bind()
);
router.post(
  "/getCryptoMntWithdrawalHistory",
  ensureWebTokenForAdmin,
  adminController.getCryptoMntWithdrawalHistory.bind()
);
router.post(
  "/approveWithdrwalRequest",
  ensureWebTokenForAdmin,
  adminController.approveWithdrwalRequest.bind()
);
router.post(
  "/rejectWithdrwalRequest",
  ensureWebTokenForAdmin,
  adminController.rejectWithdrwalRequest.bind()
);
router.post(
  "/getTransactionHistory",
  ensureWebTokenForAdmin,
  adminController.getTransactionHistory.bind()
);
router.post(
  "/getPhaseList",
  ensureWebTokenForAdmin,
  adminController.getPhaseList.bind()
);
router.post(
  "/updatePhase",
  ensureWebTokenForAdmin,
  adminController.updatePhase.bind()
);
router.post(
  "/updatePhaseStatus",
  ensureWebTokenForAdmin,
  adminController.updatePhaseStatus.bind()
);
router.post(
  "/getStackingSetting",
  ensureWebTokenForAdmin,
  adminController.getStackingSetting.bind()
);
router.post(
  "/getSystemSetting",
  ensureWebTokenForAdmin,
  adminController.getSystemSetting.bind()
);
router.post(
  "/updateSystemSetting",
  ensureWebTokenForAdmin,
  adminController.updateSystemSetting.bind()
);
router.post(
  "/getDynamicPrice",
  ensureWebTokenForAdmin,
  adminController.getDynamicPrice.bind()
);
router.post(
  "/getSubscriberList",
  ensureWebTokenForAdmin,
  adminController.getSubscriberList.bind()
);
router.post(
  "/changePassword",
  changePasswordSchema,
  ensureWebTokenForAdmin,
  adminController.changePassword.bind()
);
router.post(
  "/getActivePhaseAdmin",
  ensureWebTokenForAdmin,
  adminController.getActivePhaseAdmin.bind()
);
router.post(
  "/loginAsUser",
  ensureWebTokenForAdmin,
  adminController.loginAsUser.bind()
);
router.post(
  "/userblock",
  ensureWebTokenForAdmin,
  adminController.userblock.bind()
);
router.post(
  "/userUnblock",
  ensureWebTokenForAdmin,
  adminController.userUnblock.bind()
);
router.post("/showSystemSetting", adminController.getSystemSetting.bind());
router.post(
  "/updateTradeFee",
  ensureWebTokenForAdmin,
  adminController.updateTradeFee.bind()
);
router.post(
  "/getCryptoMntWithdrawalHistoryAdmin",
  ensureWebTokenForAdmin,
  adminController.getCryptoMntWithdrawalHistoryAdmin.bind()
);
...
router.post(
  "/blogdelete",
  ensureWebTokenForAdmin,
  adminController.blogdelete.bind()
);
router.post(
  "/insertblog",
  blogimages,
  ensureWebTokenForAdmin,
  adminController.insertblog.bind()
);
router.post(
  "/updateblog",
  blogimages,
  ensureWebTokenForAdmin,
  adminController.updateblog.bind()
);
...
router.post(
  "/getuserDetails",
  blogimages,
  adminController.getuserDetails.bind()
);
...
router.post(
  "/updateBlogSlider",
  blogimages,
  adminController.updateBlogSlider.bind()
);
...
router.post(
  ...
  adminController.insertTransactionHash.bind()
);
router.post(
  "/updatecryptowithdraw",
  ensureWebTokenForAdmin,
  adminController.updatecryptowithdraw.bind()
);
...
router.post(
  ...
  achieverimages,
  insertachieverSchema,
  adminController.inserAchiever.bind()
);
router.post(
  "/updateachieve",
  achieverimages,
  adminController.updateachieve.bind()
);
...
router.post(
  "/insertfaqs",
  ensureWebTokenForAdmin,
  cmsController.insertfaqs.bind()
);
router.post(
  "/updatefaqs",
  ensureWebTokenForAdmin,
  cmsController.updatefaqs.bind()
);
router.post(
  "/deletefaqs",
  ensureWebTokenForAdmin,
  cmsController.deletefaqs.bind()
);
...
router.post(
  "/getaboutus",
  ensureWebTokenForAdmin,
  cmsController.getaboutus.bind()
);
router.post(
  "/updateaboutus",
  ensureWebTokenForAdmin,
  cmsController.updateaboutus.bind()
);
...
router.post(
  "/getprivacypolicy",
  ensureWebTokenForAdmin,
  cmsController.getprivacypolicy.bind()
);
router.post(
  "/updateprivacypolicy",
  ensureWebTokenForAdmin,
  cmsController.updateprivacypolicy.bind()
);
...
router.post(
  "/getcookiepolicy",
  ensureWebTokenForAdmin,
  cmsController.getcookiepolicy.bind()
);
router.post(
  "/updatecookiepolicy",
  ensureWebTokenForAdmin,
  cmsController.updatecookiepolicy.bind()
);
...
router.post(
  "/getcontactus",
  ensureWebTokenForAdmin,
  cmsController.getcontactus.bind()
);

router.post(
  "/getbankdetails",
  ensureWebTokenForAdmin,
  cmsController.getbankdetails.bind()
);
router.post(
  "/updatebankdetails",
  ensureWebTokenForAdmin,
  cmsController.updatebankdetails.bind()
);
...
router.post(
  "/getbuyrequest",
  ensureWebTokenForAdmin,
  cmsController.getbuyrequest.bind()
);
router.post(
  "/updatebuyrequest",
  ensureWebTokenForAdmin,
  adminController.updatebuyrequest.bind()
);
router.post(
  "/rejectbuyrequest",
  ensureWebTokenForAdmin,
  adminController.rejectbuyrequest.bind()
);

router.post(
  "/minwithdraw",
  ensureWebTokenForAdmin,
  cmsController.minwithdraw.bind()
);
router.post(
  "/updatewithdraw",
  ensureWebTokenForAdmin,
  cmsController.updatewithdraw.bind()
);
router.post("/showminwithdraw", cmsController.minwithdraw.bind());

router.post(
  "/dailymaxwithdrawlimit",
  cmsController.dailymaxwithdrawlimit.bind()
);
...
router.post(
  "/getwithdrawhistory",
  ensureWebTokenForAdmin,
  cmsController.getwithdrawhistory.bind()
); //not working sql
router.post(
  "/getReferalEarning",
  ensureWebTokenForAdmin,
  cmsController.getReferalEarning.bind()
); //not working sql
router.post(
  "/getstackingEarning",
  ensureWebTokenForAdmin,
  cmsController.getstackingEarning.bind()
);
router.post(
  "/getPrchaseHistory",
  ensureWebTokenForAdmin,
  cmsController.getPrchaseHistory.bind()
);

router.post(
  "/getexchangetransaction",
  ensureWebTokenForAdmin,
  adminController.getexchangetransaction.bind()
);
router.post(
  "/updateexchangetransaction",
  ensureWebTokenForAdmin,
  adminController.updateexchangetransaction.bind()
);
router.post(
  "/rejectexchangetransaction",
  ensureWebTokenForAdmin,
  adminController.rejectexchangetransaction.bind()
);
...
const Transfer = require("../controllers/API/transferAPIs");
...
router.post(
  "/activeDeactivecoinPairs",
  exadminController.activeDeactivecoinPairs.bind()
);
...
router.post(
  ...
  ticketSchema,
  ensureWebToken,
  exadminController.insertticket.bind()
);
router.post("/getallticket", exadminController.getallticket.bind());
router.post(
  "/ticketapprove",
  ensureWebTokenForAdmin,
  exadminController.ticketapprove.bind()
);
router.post(
  "/ticketreject",
  ensureWebTokenForAdmin,
  exadminController.ticketreject.bind()
);
...
router.post(
  "/updatedeposit_content",
  ensureWebTokenForAdmin,
  exadminController.updatedeposit_content.bind()
);
router.post(
  "/updatereferral_content",
  ensureWebTokenForAdmin,
  exadminController.updatereferral_content.bind()
);
router.post(
  "/updatekyc_content",
  ensureWebTokenForAdmin,
  exadminController.updatekyc_content.bind()
);
router.post(
  "/updateterms_condition",
  ensureWebTokenForAdmin,
  exadminController.updateterms_condition.bind()
);
router.post(
  "/updateprivacy_policy",
  ensureWebTokenForAdmin,
  exadminController.updateprivacy_policy.bind()
);
router.post(
  "/updateabout",
  ensureWebTokenForAdmin,
  exadminController.updateabout.bind()
);

router.post(
  "/getannouncement",
  ensureWebTokenForAdmin,
  exadminController.getannouncement.bind()
);
router.post(
  "/insertannouncement",
  ensureWebTokenForAdmin,
  exadminController.insertannouncement.bind()
);
router.post(
  "/updateannouncement",
  ensureWebTokenForAdmin,
  exadminController.updateannouncement.bind()
);
router.post(
  "/inactiveannouncement",
  ensureWebTokenForAdmin,
  exadminController.inactiveannouncement.bind()
);
router.post(
  "/activeannouncement",
  ensureWebTokenForAdmin,
  exadminController.activeannouncement.bind()
);
router.post(
  "/deleteannouncement",
  ensureWebTokenForAdmin,
  exadminController.deleteannouncement.bind()
);

router.post(
  "/transactiontype",
  ensureWebTokenForAdmin,
  exadminController.transactiontype.bind()
);
router.post(
  "/transactionfilter",
  exadminController.transactionFilterRecord.bind()
);
...
router.post(
  "/approvedepositadmininr",
  exadminController.approvedepositadmininr.bind()
);
router.post(
  "/rejectdepositadmininr",
  exadminController.rejectdepositadmininr.bind()
);
...
router.post(
  "/disableAuth",
  ensureWebToken,
  exuserController.disableAuth.bind()
);
router.post(
  "/twoAuthenticationVerify",
  exuserController.twoAuthenticationVerify.bind()
);
...
router.post(
  "/createOrder",
  ensureWebToken,
  exuserController.createOrder.bind()
);
router.post(
  "/cancelOrder",
  ensureWebToken,
  exuserController.cancelOrder.bind()
);
...
router.post(
  "/coindetail",
  ensureWebToken,
  exwithdrawController.coinDetail.bind()
);

router.post(
  "/cryptowithdraw",
  ensureWebToken,
  exwithdrawController.cryptowithdraw.bind()
);
router.post(
  "/cryptowithdrawvalidation",
  ensureWebToken,
  exwithdrawController.checkCryptowithdrawvalidation.bind()
);
router.post(
  "/withdrawAuthentication",
  ensureWebToken,
  exwithdrawController.withdrawAuthentication.bind()
);
router.post("/depositForm", receipt, exwithdrawController.depositForm.bind());
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

// test get balance
router.get("/getbalance", testController.getBalance);
